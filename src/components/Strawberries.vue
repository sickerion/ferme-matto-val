  ...
  <div class="strawberries-container">
    <b-row>
      <b-col class="container-padding" lg="4" align-self="center">
        <div class="text-zone">
          <h1 class="title text title-padding">Des fraises pour tous les goûts</h1>
          <p class="text">
            Que vous les préférez sucrées ou juteuses, grosses ou petites, nos 12 variétés de fraise vous charmerons de la mi-juin à la fin juillet. 
